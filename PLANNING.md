...
- Progress checkpoint (Codex-verified 2026-07-20): Doctor dashboards on Android and web now show a Europe/Belgrade-aligned seven-day adherence summary for every linked patient, including submitted, current draft, past incomplete, and no-activity states plus symptom and stool recorded/confirmed-none/missing checkpoints. Obsolete intake-list, quality-of-life-effect, and general-description fields were removed from doctor views and exports. Local typecheck, lint, 224 tests, and web build passed; the migration was applied to the linked Supabase project, the live export/RLS suite passed, and post-migration function/grant checks confirmed anon export remains blocked. Android and browser visual review remain pending.
